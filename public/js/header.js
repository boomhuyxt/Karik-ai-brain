function initHeaderModule() {
    ...
    try {
        ...
        if (userInfoRaw) {
            ...
            userRole = user.role || (email.includes('admin') ? 'admin' : 'user');
            const name = user.fullName || user.email || (userRole === 'admin' ? 'AI Admin' : 'User');
            ...
            if (userRoleTag) {
                userRoleTag.textContent = userRole.toUpperCase();
                if (userRole !== 'admin') {
            ...
            if (userRoleTagMobile) {
                userRoleTagMobile.textContent = userRole.toUpperCase();
                if (userRole !== 'admin') {
